...
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "7842876141:AAGO3glTFkYIuKt3MG6TI_Ct1IFdU33FFho")
...
CHANNEL_ID = int(os.environ.get("CHANNEL_ID", "-1002564916228"))

#OWNER ID --⚠️ REQUIRED--
OWNER_ID = int(os.environ.get("OWNER_ID", "6868089702"))
